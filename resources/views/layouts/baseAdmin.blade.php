...
<head>
    ...
    <link rel="icon" href="{{asset('assets/images/favicon.ico')}}" type="image/x-icon">
    <meta name="theme-color" content="#162be8">
    ...
    <title>copération assousiel</title>
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('admin.index')}}" class="nav-link menu-title">Home</a></li>
                                            <li><a href="{{route('shop.index')}}" class="nav-link menu-title">gestion des produit </a></li>
