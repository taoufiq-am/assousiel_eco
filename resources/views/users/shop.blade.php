...
<div>
    ...
    <form id="frmFilter" method="GET">
        ...
        <input type="hidden" id="categories" name="order" value="{{$q_categories}}" /> 
        </form>
        ...
        function addProductToWishlist(id, name, quantity, price) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.status === 200) {
                        $.notify("Item successfully added to your wishlist", "success");
                    } else {
                        $.notify("Failed to add item to your wishlist", "error");
                    }
                },
                error: function(xhr, status, error) {
                    console.log("Error:", error);
                    $.notify("There was an error adding the item to your wishlist. Please try again.", "error");
                }
            });
        }
